...
const SHORTCUTS: Shortcut[] = [
  ...
  { keys: '↑', action: 'Return to section top from subtopic', category: 'Navigation' },
  { keys: 'Esc', action: 'Close modal · go up one level', category: 'Navigation' },
  { keys: 'Home', action: 'Jump to cover', category: 'Navigation' },
  { keys: 'M', action: 'Toggle menu', category: 'Display' },
  { keys: 'F', action: 'Toggle fullscreen', category: 'Display' },
  { keys: 'Ctrl + B', action: 'Toggle sidebar (alternative)', category: 'Display' },
